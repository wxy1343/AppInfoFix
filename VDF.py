...
class VDF:
    ...
    def __init__(self, chooseApps=False, apps=None, steam_path=None):
        ...
        ### LOAD VDF FILE ###
        self.vdfPath = Path(self.steam_path) / 'appcache' / 'appinfo.vdf'
        with self.vdfPath.open('rb') as vdf:
    ...
    def write_data(self):
        with self.vdfPath.open('wb') as vdf:
